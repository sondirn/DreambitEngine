...
public struct RectangleF : IEquatable<RectangleF>
{
    ...
    /// <summary>
    ///     Gets whether the provided coordinates lie within the bounds of this
    ///     <see cref="T:Microsoft.Xna.Framework.Rectangle" />.
    /// </summary>
    ...
    {
        return X <= (double)x && x < (double)(X + Width) && Y <= (double)y && y < (double)(Y + Height);
    }

    /// <summary>
    ///     Gets whether the provided <see cref="T:Microsoft.Xna.Framework.Point" /> lies within the bounds of this
    ///     <see cref="T:Microsoft.Xna.Framework.Rectangle" />.
    /// </summary>
    /// <param name="value">The coordinates to check for inclusion in this <see cref="T:Microsoft.Xna.Framework.Rectangle" />.</param>
    /// <returns>
    ///     <c>true</c> if the provided <see cref="T:Microsoft.Xna.Framework.Point" /> lies inside this
    ...
    /// <summary>
    ///     Gets whether the provided <see cref="T:Microsoft.Xna.Framework.Vector2" /> lies within the bounds of this
    ///     <see cref="T:Microsoft.Xna.Framework.Rectangle" />.
    /// </summary>
    /// <param name="value">The coordinates to check for inclusion in this <see cref="T:Microsoft.Xna.Framework.Rectangle" />.</param>
    /// <returns>
    ...
    {
        return X <= (double)value.X && value.X < (double)(X + Width) && Y <= (double)value.Y &&
               value.Y < (double)(Y + Height);
    }
    ...
    {
        result = X <= (double)value.X && value.X < (double)(X + Width) && Y <= (double)value.Y &&
                 value.Y < (double)(Y + Height);
    }

    /// <summary>
    ///     Gets whether the provided <see cref="T:Microsoft.Xna.Framework.Rectangle" /> lies within the bounds of this
    ///     <see cref="T:Microsoft.Xna.Framework.Rectangle" />.
    /// </summary>
    /// <param name="value">
    ...
    /// <summary>
    ///     Gets whether the other <see cref="T:Microsoft.Xna.Framework.Rectangle" /> intersects with this rectangle.
    /// </summary>
